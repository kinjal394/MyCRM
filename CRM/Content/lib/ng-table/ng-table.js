(function (angular, factory) {
    ...
    angular.module('ngTable').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('ng-table/filters/text.html', '<input type="text" name="{{name}}" placeholder="search" ng-disabled="$filterRow.disabled" ng-model="params.filter()[name]" class="input-filter form-control" placeholder="{{getFilterPlaceholderValue(filter, name)}}"/> <button class="close btn-clear-ng-table-filter" data-ng-click="params.filter()[name] = \'\'">&times;</button>');
        $templateCache.put('ng-table/filters/date.html', '<elaunch-datepicker data-ng-model="params.filter()[name]" date-options="dateOptions" isRequired="false" week-off="0"></elaunch-datepicker>');
        $templateCache.put('ng-table/filters/time.html', '<elaunch-timepicker data-ng-model="params.filter()[name]" hstep="1" mstep="1" is-meridian="ismeridian" is-required="false" placeholder="{{getFilterPlaceholderValue(filter, name)}}"></elaunch-timepicker>');
        $templateCache.put('ng-table/filters/dropdown.html', '<elaunch-autocomplete min-chars="0" mode="Status" isdisplay="true" data-ng-model="params.filter()[name]"></elaunch-autocomplete>');
